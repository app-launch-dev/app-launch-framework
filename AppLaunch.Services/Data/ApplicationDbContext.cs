        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            try
            {
                ...
                modelBuilder.Entity<IdentityRole>().HasData(
                    new IdentityRole
                    {
                        Id = new Guid("21ab5e5f-43e1-40eb-9bef-b26ac0dc6751").ToString(), Name = "Admin",
                        NormalizedName = "ADMIN"
                    },
                    new IdentityRole
                    {
                        Id = new Guid("0b5b6765-40c8-410a-9271-92651118a908").ToString(), Name = "Manager",
                        NormalizedName = "MANAGER"
                    },
                    new IdentityRole
                    {
                        Id = new Guid("d68c4c67-c79b-4f43-8795-feddccaf0832").ToString(), Name = "Public",
